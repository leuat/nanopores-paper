...
In our cost function (the $\chi^2$ measure), we have ignored the low $r$ values of $g(r)$ since the pore geometry does not depend on the intra-molecular structure, but only the density variations at larger distances.
